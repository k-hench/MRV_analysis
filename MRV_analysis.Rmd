---
title: "MRV analysis (`r params$this_year`)"
author: "Kosmas Hench"
date: "11/27/2021"
...
knit: (
  function(inputFile, encoding) { 
    ...
    rmarkdown::render( 
      input       = inputFile, 
      encoding    = encoding, 
      params      = list(this_year = year),      
      output_file = paste0("MRV_analysis", year,".html")) })
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, fig.asp = .6, fig.width = 9)
```
...
Analysis for `r this_year`, using the report version `r this_version`.
